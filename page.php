  ...
  <div id="wrapper">
   <div id="contenido">
    ...
    <ul class="botones_sociales">
      ...
      <div class="meta"><b>Por: </b><?php the_author_link(); ?> <b>Fecha: </b><?php the_time('F') ?> <?php the_time('j') ?>, <?php the_time('Y') ?> <b>Comentarios: </b><?php comments_number('0', '1', '%' ); ?></div>
	   ...
	   <?php
        ...
        <a href="javascript:comentar_fb()" style="text-align:center; padding:10px; background:#1A478C; color:#FFF; font-weight:bold; display:block; width:100%">Comentar con Facebook</a>
        <div class="fb-comments" id="comentar_fb" data-href="http://www.sitiopixel.com/wppractical/integer-lacinia-velit-ac-ornare-viverra/" data-numposts="5" data-colorscheme="light"></div>
